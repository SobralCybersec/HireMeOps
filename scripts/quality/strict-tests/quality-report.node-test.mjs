...
test("quality report parses Lizard metrics and source extensions", () => {
  assert.deepEqual(
    parseLizardFindings(
      "src/main.rs:12: warning: start_proxy has 153 NLOC, 17 CCN, 1058 token, 2 PARAM, 153 length, 0 ND\n",
    ),
    [
      {
...
test("quality report includes test, duplication, coverage, and gate metrics", () => {
  const report = formatQualityReport({
    ...
    jscpd: {
      summary: { files: 2, lines: 30, clones: 0, duplicated_lines: 0, duplication_percent: 0 },
    },
    lizard: [],
