...
function VariantEducationTab({ model }: { model: ProfileVariantsModel }) {
...
function VariantExperienceTab({ model }: { model: ProfileVariantsModel }) {
  const { activeTab, selectedDto } = model;
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--sp-3)" }}>
      ...
      >
        {
          "Structured experience for this variant — role, employer, location, dates, and achievement bullets."
        }
      </p>
