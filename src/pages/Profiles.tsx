...
export function Profiles() {
  ...
  // Auto-select first profile when data lands
  useEffect(() => {
    if (selectedId === null && profiles.length > 0) setSelectedId(profiles[0].id);
  }, [profiles, selectedId]);

  // Reset local form state when the selected profile changes
  useEffect(() => {
    setFacts(BLANK_FACTS);
    setLinks(BLANK_LINKS);
            ...
            {profiles.length === 0 ? (
              ...
              <ul style={{ listStyle: "none", margin: 0, padding: 0 }}>
                {profiles.map((p) => (
                  <li
                    key={p.id}
                    className={selectedId === p.id ? "list-item selected" : "list-item"}
                ...
                <div className="section-group">
                  ...
                  >
                    <div>
                      ...
                      >
                        {selected.id === activeProfileId ? "Active profile" : "Inactive"}
                      </div>
                ...
                <div className="section-group">
                  ...
                  <div className="form-grid">
                    <div className="field" style={{ gridColumn: "1 / -1" }}>
                      ...
                      >
                        {`~/.hiremeops/profiles/${selected.id}/browser`}
                      </code>
